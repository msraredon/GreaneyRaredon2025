...
# I did it the following way: The STAR output is a weird mtx which contains all  matrices in one file. I am splitting these  with this 
# oh, and define ncores (like: ncores=8). Then you can multihread the stuff in case you have several samples.
...
# then, with the the thresholds percent mito, fraction intronic and nUMI (Taylor can show you), 
# i extract the "real" cells with this: 
# (oh, and select the pattern how mito genes are names based on your species)

...
STAR.path <- "/gpfs/loomis/pi/kaminski/public/softwares/STAR-2.7.3a/bin/Linux_x86_64_static/STAR"
# genome.dir <- "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_human/GENECODE_release31_GRCh38.p12/STAR_Index_noGTF"
# GTF.path <-  "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_human/GENECODE_release31_GRCh38.p12/GTF/gencode.v31.annotation.gtf"
# genome.dir <- "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_mouse/M22_GRCm38.p6_GENECODE/STAR_Index_noGTF"
# GTF.path <-  "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_mouse/M22_GRCm38.p6_GENECODE/GTF/gencode.vM22.annotation.gtf"
# genome.dir <- "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_mouse/M22_GRCm38.p6_GENECODE/STAR_Index_noGTF_eGFP_tdTomato"
# GTF.path <-  "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_mouse/M22_GRCm38.p6_GENECODE/GTF/gencode.vM22.annotation.eGFP.tdTomato.gtf"
# genome.dir <- "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_human/GENECODE_release31_GRCh38.p12/STAR_Index_noGTF_viral"
# GTF.path <-  "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_human/GENECODE_release31_GRCh38.p12/VIRAL_GENOMES/combined.human.viral.gtf"
genome.dir <- "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_rat/ensembl_release99_Rnor6.0/STAR_Index_noGTF"
GTF.path <-  "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_rat/ensembl_release99_Rnor6.0/GTF/Rattus_norvegicus.Rnor_6.0.99.gtf"
# genome.dir <- "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_human/GENECODE_release34_GRCh38.p13/STAR_Index_noGTF_wCovid"
# GTF.path <-  "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/genome_index_human/GENECODE_release34_GRCh38.p13/GTF/combined.humanGRCh38p13.wuhCor1.gtf"


# CBwhitelist.path <- "/gpfs/loomis/project/fas/kaminski/public/Backup/Jonas/softwares/10x_Whitelists/3M-february-2018.txt"
CBwhitelist.path <- "/gpfs/loomis/pi/kaminski/public/Backup/Jonas/softwares/10x_Whitelists/737K-august-2016.txt"
...
STAR.options <- paste("--soloType CB_UMI_Simple --readFilesCommand zcat --soloBarcodeReadLength 0 ", 
                      ...
                      "--soloCBlen 16 --soloUMIstart 17 --soloUMIlen 10 --twopassMode Basic --soloStrand Forward", sep="") 
